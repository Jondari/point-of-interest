...
export interface SpanishPOISeed {
  id: string;
  cityId: Extract<OfflineCityId, 'madrid' | 'barcelona' | 'bilbao' | 'canary-islands'>;
...
export function createSpanishPOI(seed: SpanishPOISeed): OfflinePOI {
  return {
    ...seed,
    imageAlt: {
