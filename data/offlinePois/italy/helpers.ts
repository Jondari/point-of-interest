...
export interface ItalianPOISeed {
  id: string;
  cityId: Extract<OfflineCityId, 'rome' | 'florence' | 'venice' | 'naples'>;
...
export function createItalianPOI(seed: ItalianPOISeed): OfflinePOI {
  return {
    ...seed,
    imageAlt: {
