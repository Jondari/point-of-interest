...
export interface GermanPOISeed {
  id: string;
  cityId: Extract<OfflineCityId, 'berlin' | 'frankfurt'>;
...
export function createGermanPOI(seed: GermanPOISeed): OfflinePOI {
  return {
    ...seed,
    imageAlt: { fr: 'Vue de ' + seed.name.fr, en: 'View of ' + seed.name.en, zh: seed.name.zh + '景观' },
    practicalInfo: [
      {
